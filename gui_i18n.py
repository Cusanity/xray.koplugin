...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "zh": {
        ...
        "AI Models & Chain": "AI 模型与重试链",
        "API Credentials": "API 密钥与凭据",
        "Performance & Limits": "性能与限制",
        "Cloud & Device Sync": "云端与设备同步",
        "General & Storage": "常规与存储",
        "All Settings": "所有设置",
        "Configure Sync Settings": "配置同步设置",
        "More Actions": "更多操作",
        "Cloud Sync Actions": "云端同步操作",
        "WebDAV Cloud Actions": "WebDAV 云端操作",
        "Search books by title or author…": "按书名或作者搜索书籍…",
        "Sync Center": "同步中心",
        "Device Wi-Fi Direct Push": "设备 Wi-Fi 直连推送",
        "Push Selected Book to KOReader": "推送所选书籍至 KOReader",
        "Calibre Library": "Calibre 书库",
        "WebDAV Cloud Storage": "WebDAV 云端存储",
        # Config tab
        ...
        "Use GitHub device login; no API key is required.": "使用 GitHub 设备登录；无需 API 密钥。",
        "Login with GitHub": "使用 GitHub 登录",
        "Re-login with GitHub": "重新使用 GitHub 登录",
        "GitHub login saved. Copilot token will be fetched on demand.": "已保存 GitHub 登录。Copilot 令牌将在需要时获取。",
        "Copilot token expires soon ({time}); it will refresh automatically.": "Copilot 令牌即将过期（{time}）；将自动刷新。",
        "Copilot token valid until {time}.": "Copilot 令牌有效期至 {time}。",
        "Copilot token expired; it will refresh automatically.": "Copilot 令牌已过期；将自动刷新。",
        "Login with GitHub Copilot, then refresh models.": "请先登录 GitHub Copilot，然后刷新模型。",
        # Gemini Batch API
        "Use Gemini Batch API (50% cost discount)": "使用 Gemini Batch API（费用优惠 50%）",
        "Submit chunk analysis to Google's Batch API for 50% cost savings. Chunks are processed asynchronously (SLO up to 24h, often minutes).": "将切片文本分析提交给 Google Batch API，享受 50% 的费用优惠。任务将异步处理（SLO 最长 24 小时，通常仅需数分钟）。",
        "Use Google Gemini Batch API for 50% cost savings.": "使用 Google Gemini Batch API 可节省 50% 的费用。",
        "Batch API is only supported when Google Gemini is the selected provider.": "仅当选择 Google Gemini 作为提供商时才支持 Batch API。",
        "  \u2022 Gemini Batch API: enabled (50% cost discount, async processing)": "  • Gemini Batch API：已启用（费用优惠 50%，异步批处理）",
        "Starting GitHub Copilot login\u2026": "正在启动 GitHub Copilot 登录…",
        "GitHub Copilot Login": "GitHub Copilot 登录",
        "Open {url} and enter code: {code}": "打开 {url} 并输入代码：{code}",
        "Waiting for GitHub authorization\u2026": "正在等待 GitHub 授权…",
        "GitHub Copilot login complete.": "GitHub Copilot 登录完成。",
        "GitHub Copilot login complete. You can refresh models now.": "GitHub Copilot 登录完成。现在可以刷新模型。",
        "GitHub Copilot login failed: {error}": "GitHub Copilot 登录失败：{error}",
        "GitHub Copilot login failed.": "GitHub Copilot 登录失败。",
        # Books tab
        "Scan Library": "扫描书库",
        "Add EPUB…": "添加 EPUB…",
        ...
        "Cooldown (s)": "冷却(s)",
        "Price ($/M tok)": "价格 $/M",
        "Input: {inp}/M, Output: {out}/M": "输入：{inp}/M，输出：{out}/M",
        "Input ($/M tok)": "输入 $/M",
        "Output ($/M tok)": "输出 $/M",
    ...
    "zh_TW": {
        ...
        "X-Ray": "X-Ray",
        # Settings hub categories
        "AI Models & Chain": "AI 模型與重試鏈",
        "API Credentials": "API 金鑰與憑證",
        "Performance & Limits": "效能與限制",
        "Cloud & Device Sync": "雲端與設備同步",
        "General & Storage": "常規與存儲",
        "All Settings": "所有設定",
        "Configure Sync Settings": "配置同步設定",
        "More Actions": "更多操作",
        "Cloud Sync Actions": "雲端同步操作",
        "WebDAV Cloud Actions": "WebDAV 雲端操作",
        "Search books by title or author…": "按書名或作者搜尋書籍…",
        "Sync Center": "同步中心",
        "Device Wi-Fi Direct Push": "設備 Wi-Fi 直連推送",
        "Push Selected Book to KOReader": "推送所選書籍至 KOReader",
        "Calibre Library": "Calibre 書庫",
        "WebDAV Cloud Storage": "WebDAV 雲端儲存",
        ...
        "Use GitHub device login; no API key is required.": "使用 GitHub 裝置登入；不需要 API 金鑰。",
        "Login with GitHub": "使用 GitHub 登入",
        "Re-login with GitHub": "重新使用 GitHub 登入",
        "GitHub login saved. Copilot token will be fetched on demand.": "已儲存 GitHub 登入。Copilot 權杖會在需要時取得。",
        "Copilot token expires soon ({time}); it will refresh automatically.": "Copilot 權杖即將過期（{time}）；將自動重新整理。",
        "Copilot token valid until {time}.": "Copilot 權杖有效至 {time}。",
        "Copilot token expired; it will refresh automatically.": "Copilot 權杖已過期；將自動重新整理。",
        "Login with GitHub Copilot, then refresh models.": "請先登入 GitHub Copilot，然後重新整理模型。",
        # Gemini Batch API
        "Use Gemini Batch API (50% cost discount)": "使用 Gemini Batch API（費用優惠 50%）",
        "Submit chunk analysis to Google's Batch API for 50% cost savings. Chunks are processed asynchronously (SLO up to 24h, often minutes).": "將切片文本分析提交給 Google Batch API，享受 50% 的費用優惠。任務將非同步處理（SLO 最長 24 小時，通常僅需數分鐘）。",
        "Use Google Gemini Batch API for 50% cost savings.": "使用 Google Gemini Batch API 可節省 50% 的費用。",
        "Batch API is only supported when Google Gemini is the selected provider.": "僅當選擇 Google Gemini 作為提供商時才支援 Batch API。",
        "  \u2022 Gemini Batch API: enabled (50% cost discount, async processing)": "  • Gemini Batch API：已啟用（費用優惠 50%，非同步批次處理）",
        "Starting GitHub Copilot login\u2026": "正在啟動 GitHub Copilot 登入…",
        "GitHub Copilot Login": "GitHub Copilot 登入",
        "Open {url} and enter code: {code}": "開啟 {url} 並輸入代碼：{code}",
        "Waiting for GitHub authorization\u2026": "正在等待 GitHub 授權…",
        "GitHub Copilot login complete.": "GitHub Copilot 登入完成。",
        "GitHub Copilot login complete. You can refresh models now.": "GitHub Copilot 登入完成。現在可以重新整理模型。",
        "GitHub Copilot login failed: {error}": "GitHub Copilot 登入失敗：{error}",
        "GitHub Copilot login failed.": "GitHub Copilot 登入失敗。",
        "Scan Library": "掃描書庫",
        "Add EPUB…": "新增 EPUB…",
        ...
        "Cooldown (s)": "冷卻(s)",
        "Price ($/M tok)": "價格 $/M",
        "Input: {inp}/M, Output: {out}/M": "輸入：{inp}/M，輸出：{out}/M",
        "Input ($/M tok)": "輸入 $/M",
        "Output ($/M tok)": "輸出 $/M",
